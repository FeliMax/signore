...
export const ProjectCard = ({name, description, year, type, references}: ProjectContent) => {
    return (
        <article
            className="relative bg-white overflow-hidden flex flex-col items-center gap-6 min-h-[20rem] w-[18rem] rounded-lg p-4 md:hover:scale-110 duration-300">
            ...
            <div className="flex flex-col items-center gap-4">
                <div className="w-24 h-24 mt-4 z-10">
                    <Image className="object-contain" src={Me} alt="Project image"/>
                </div>
                ...
                <div className="text-sm absolute bottom-0 right-0 bg-gray-300 pl-4 pr-2 py-1">{type}</div>
            </div>
        </article>
    )
}