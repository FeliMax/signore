        ...
        <section className="mb-24 mx-4">
            <div className="container px-6 flex justify-between flex-wrap gap-48 w-full -mt-36 py-16 px-12 bg-white text-gray-800 rounded-2xl shadow ">
                <div className="flex flex-col items-center flex-1 text-center">
                    ...
                    <h6 className="text-portfolio-blue mb-2">
                        Languages I speak:
                    </h6>
                    <p className="mb-6">
                        HTML, CSS, Sass, Javascript/Typescript, Python, C++,
                        Dart
                    </p>
                ...
                <div className="flex flex-col items-center text-center flex-1">
                    ...
                    <p className="mb-6">
                        Beside coding and all the interesting IT topics I like
                        to stay outside
                    </p>
                    <h6 className="text-portfolio-blue mb-2">Tech interests</h6>
                    <p className="mb-6">
                        Tech interests Linux, Flutter, WebDevelopment, React
                    </p>
                </div>
            </div>
        </section>
